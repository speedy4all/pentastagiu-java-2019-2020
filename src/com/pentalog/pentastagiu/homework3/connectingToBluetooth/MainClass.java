...
public class MainClass {
    ...
    public static void main(String[]args) {
        ConnectableInterface carFord=new Car(10003, "Ford Fiesta", "1.5 TDCi 85HP Spec", 12300.00, 2017, "Red", 3.5, "Diesel");
        ConnectableInterface iPhone1=new Phone(30001, "iPhone", "X", "Silver", 3750.00, 64.00, 12.12);
        ConnectableInterface refrigeratorLg=new SmartRefrigerator(20003, "LG", "GSX961NSAZ", 405.00, 196.00, "A++");
