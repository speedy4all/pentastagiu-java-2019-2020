...
public class WEBINAR2_HOMEWORK {
        ...
        public static void main(String[] args) {
            ...
            ///2nd exercise
            System.out.println("2.Read another 2 elements");
            a = input.nextInt();
            int b = input.nextInt();
    ...
    int lung=s6.length();
        ...
        if(s6.charAt(lung-2)==s6.charAt(lung-1))
        {
            String aux1=s6.substring(0,lung-1);
            String aux2=s6.substring(lung-1,lung-1);
            s6=aux1+'#';
            s6=s6+aux2;
